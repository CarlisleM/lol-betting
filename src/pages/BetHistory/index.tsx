...
const TeamSelectLabel = styled.div`
    width: 47.5%;
    font-weight: 700;
`
...
const LeagueSelectLabel = styled.div`
    width: 25%;
    font-weight: 700;
`

const MatchSelect = styled.div`
    width: 52.5%;
    display: flex;
    justify-content: center;
`

const MapSelectLabel = styled.div`
    width: 17.5%;
    font-weight: 700;
`
...
const MatchSelectLabel = styled.div`
    width: 52.5%;
    font-weight: 700;
`
...
const ObjectiveSelectLabel = styled.div`
    width: 47.5%;
    font-weight: 700;
`
...
const CreateBet = styled.div`
    width: 33.75%;
    height: 100px;
`

const DisplayBets = styled.div`
    width: 63.75%;
    height: 100px;
`

const CreateBetRow = styled.div`
    display: flex;
    justify-content: space-between;
`

const CreateBetRowLabels = styled.div`
    display: flex;
    justify-content: space-between;
    padding-top: 7px;
    padding-bottom: 3px;
...
const BetRowSelected = styled.div`
    display: flex;
    justify-content: center;
    align-items: center;
    width: 18%;
...
const BetRowObjective = styled.div`
    display: flex;
    justify-content: center;
    align-items: center;
    width: 18%;
...
function BetHistory() {
    ...
    const excludeLeagues = ["NA_Academy_League", "LPL", "Turkey_Academy_League"]
    ...
    return (
        ...
        >
            ...
            >
                ...
                <FooterRow>
                    <div>
                        Initial Deposit:&nbsp; {betHistoryStats.initialDeposit}
                    </div>
                    <div>
                        Current Balance:&nbsp;

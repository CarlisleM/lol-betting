...
function MatchStats() {
    ...
    useEffect(() => {
        ...
        const fetchTeams = async () => {
            ...
            if (data) {
                setTeams(data.filter((team: any) => team.name !== "Test"))
            }
        }
        ...
        const fetchGames = async () => {
            const { data, error } = await supabase.from("games").select(`
				...
				blue_team,
				red_team,
				match_results ( game_id, first_blood, first_tower, first_dragon, first_inhibitor, first_baron, first_rift_herald, blue_team_kills, red_team_kills, winner, loser )
			`)

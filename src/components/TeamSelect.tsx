...
const TeamSelect = (props: Props) => {
    ...
    return (
        <TeamSelectContainer>
            {props.selectedTeam !== null ? (
                <TeamLogo>
                    <img
                        ...
                        src={`../images/teams/${props.selectedTeam.replace(
                            "!",
                            ""
                        )}.png`}
                ...
                <TeamLogo>
                    <img
                        style={{
                            ...
                            height: "85%",
                            opacity: "0.25",
                            filter: "invert(0%) sepia(0%) saturate(4433%) hue-rotate(224deg) brightness(96%) contrast(106%)",
                        }}
                        src={`../images/teams/placeholder.png`}
                        alt={`${props.selectedTeam} Logo`}
                    />
                </TeamLogo>
            )}
            ...
            {/* <ToastContainer /> TODO: creates warning in console */}
        </TeamSelectContainer>
    )
}
